...
Android 설치 조건은 **Android 7.0 이상 · 64비트 ARM · OpenGL ES 3.0**이다. 실물 휴대폰의 최소·권장 성능과 기종별 지원은 아직 미확정이다. 확인된 조건, 검증 후보 기기와 측정 절차는 [휴대폰 지원 조건](docs/device-support.md)을 참고한다.
